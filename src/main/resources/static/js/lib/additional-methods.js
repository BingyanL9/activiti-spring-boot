...
//	projectId = (projectId.length == 0) ? -1 : projectId;
//	getAjax(contextPath + "/projects/" + projectId + "/name/" + value, "", function(data, status) {
//		response = false;
//    }, false);
//	return response;
...
//
//$.validator.addMethod("uniquePipelineName", function(value, element) {
//	var response;
//	var pipelineId = $("#pipelineId").val();
//	pipelineId = (pipelineId.length == 0)? -1 : pipelineId;
//	getAjax(contextPath + "/pipelines/" + pipelineId + "/pipelinename/" + value + "/", "", function(data, status) {
//		if (status === 'success') {
//			response = !data.result;
//		} else {
//			response = false;
...
//	var response;
//	var groupName = $.trim($("#commandNameInput").val());
//	var projectId = $.trim($("#projectId").val());
//	var groupCmdId = $.trim($("#groupId").val());
//	if (!groupCmdId) {
//		groupCmdId = -1;
//	}
//    var url = contextPath + "/projects/" + projectId + "/groupcmds/" + groupCmdId + "/groupname/" + groupName;
//	getAjax(url,"", function(data, status) {
